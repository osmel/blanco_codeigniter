...
*/
$config['base_url']	='http://pepsi.dev.com/'; // 'http://45.55.85.45';

#$config['base_url']	='http://localhost/pepsi/'; // 'http://45.55.85.45';  
...
$config['sess_cookie_name']		= 'pepsi_session';
...
$config['sess_table_name']		= 'pepsi_sessions'; //'ci_sessions';
